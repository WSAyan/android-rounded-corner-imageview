package com.wsayan.roundedcornerimageview
...
class RoundedCornerImageView : AppCompatImageView {
    ...
    constructor(context: Context, attrs: AttributeSet) : super(context, attrs) {
        ...
        val roundedCorners =
            a.getInt(R.styleable.RoundedImageView_roundedCorners, ALL_ROUNDED_CORNERS_VALUE)
    ...
    private fun setupPath() {
        if (roundedTopLeft && roundedTopRight && roundedBottomRight && roundedBottomLeft
            ...
            path = circlePath(
                path,
                _paddingStart + (pathWidth / 2.0f),
                _paddingTop + (pathHeight / 2.0f),
                pathWidth,
                pathHeight,
                reverseMask
            )
            ...
            try {
                ...
                if (roundedTopLeft && roundedBottomLeft && roundedBottomRight && roundedTopRight)
                    outline.setRoundRect(
                        _paddingStart,
                        paddingTop,
                        pathWidth + _paddingStart,
                        paddingTop + pathHeight,
    ...
    companion object {
        ...
        fun circlePath(
            ...
            path.fillType =
                if (reverseMask) Path.FillType.EVEN_ODD else Path.FillType.INVERSE_EVEN_ODD
            return path
        }
        ...
        fun roundedRect(
            ...
            path.fillType =
                if (!reverseMask) Path.FillType.INVERSE_EVEN_ODD else Path.FillType.EVEN_ODD
            return path
        }
    }
}